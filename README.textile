...
This application pulls the home timeline of the user corresponding to the consumer key specified in the configuraiton file and adds the text of tweets found there to the OmniFocus inbox using AppleScript. Requires <pre>Net::Twitter::Lite</pre> and <pre>Mac::Applescript</pre>.
...
An additional parameter -- <pre>delete_messages</pre> -- controls whether the application deletes direct
